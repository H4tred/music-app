      ...
      <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden
        ...
        <div class="py-4 text-left px-6">
          ...
          <form>
            <!-- Email -->
            <div class="mb-3">
              <label for="inline-block mb-2">
              <input type="email"
                class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300 transition
                  duration-500 focus:outline-none focus:border-black rounded"
                placeholder="Enter Email" />Email</label>
            </div>
            <!-- Password -->
            <div class="mb-3">
              <label for="inline-block mb-2">
          ...
          <form>
            ...
            <div class="mb-3">
              ...
              <input type="number"
                class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300 transition
                  duration-500 focus:outline-none focus:border-black rounded" />Age</label>
            </div>
            <!-- Password -->
            <div class="mb-3">
              <label for="inline-block mb-2">
            ...
            <div class="mb-3">
              ...
              <input type="password"
                class="block w-full py-1.5 px-3 text-gray-800 border border-gray-300 transition
                  duration-500 focus:outline-none focus:border-black rounded"
                placeholder="Confirm Password" />Confirm Password</label>
            </div>
            <!-- Country -->
            <div class="mb-3">
              <label for="inline-block mb-2">
            ...
            <!-- TOS -->
            <div class="mb-3 pl-6">
            <label for="inline-block">Accept terms of service
